...
Javaskript je nastao maja 1995. godine kao \textquote{jezik-lepak} \cite{computerworld:a-z-of-js} za tadašnji dominantni brauzer Netskejp \cite{axel-rauschmayer:impatient}, kada ga je \textbf{Brendan Ajk} definisao za samo deset dana.
...
Presek za ES2018 napravljen je juna 2018. godine, a u novine se ubraja korišćenje \textsl{rest/spread} sintakse za objekte pored nizova, asinhrona iteracija (\code{for await...of} petlje), metoda \code{finally} nad prototipom promisa i imenovane grupe u regeksima \cite{axel-rauschmayer:es2018:es2019}.
