...
Konkretno je inspirisan funkcijom za traženje i \textquote{krpljenje} razlika iz jedne od ranijih verzija mikro-okvira \textit{Hyperapp}~\cite{hyperapp:patch}.
