...
\textbf{Zadatak:} \textit{Upoznati se sa stanjem ekosistema Javaskript okvir\=a i biblioteka koje se koriste za izgradnju jednostraničnih veb-aplikacija, kao i alat\=a i jezik\=a koji se koriste tokom njihovog razvitka.
...
Uporediti dobijene rezultate sa rezultatima koje daju okviri prihvaćeni u industriji i izvršiti analizu uočenih razlika.
